/*
 * nn/sampling.cpp - GPU sampling operations for token generation
 *
...
extern "C" void hip_sampling_temperature(
    Dtype dtype,
...
extern "C" void hip_sampling_repetition_penalty(
    Dtype dtype,
    StreamHandle stream_handle,
    void* logits,
...
extern "C" void hip_sampling_softmax(
    Dtype dtype,
    StreamHandle stream_handle,
    void* data,
    len_t n
...
extern "C" void hip_sampling_argmax(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* data,
    len_t n,
...
extern "C" void hip_sampling_init_indices(
    StreamHandle stream_handle,
    uint32_t* indices,
    len_t n
) {
 ...
 */
extern "C" size_t hip_sampling_topk_workspace_size(len_t n) {
    size_t temp_storage_bytes = 0;
    // Query required workspace size
    HIP_ASSERT(hipcub::DeviceRadixSort::SortPairsDescending(
...
extern "C" void hip_sampling_topk(
    Dtype dtype,
    StreamHandle stream_handle,
    void* probs,
    uint32_t* indices,
...
extern "C" void hip_sampling_multinomial(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* probs,
...
extern "C" void hip_sampling_cumsum(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* probs,
    void* cumsum,
...
extern "C" void hip_sampling_find_topp_cutoff(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* cumsum,
    len_t n,
...
extern "C" void hip_sampling_renormalize(
    Dtype dtype,
    StreamHandle stream_handle,
    void* probs,
    len_t cutoff
