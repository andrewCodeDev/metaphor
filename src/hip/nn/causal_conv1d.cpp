/*
 * nn/causal_conv1d.cpp - Depthwise causal 1D convolution forward and backward
 *
...
extern "C" void hip_nn_causal_conv1d_forward(
    Dtype dtype,
...
extern "C" void hip_nn_causal_conv1d_backward_x(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* grad,
    const void* weight,
...
extern "C" void hip_nn_causal_conv1d_backward_weight(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* grad,
    const void* x,
...
extern "C" void hip_nn_causal_conv1d_backward_bias(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* grad,
    void* grad_bias,
