/*
 * memory/cast.cpp - Dtype casting kernels
 *
...
extern "C" void hip_mem_cast(
    ...
    hipStream_t stream = cast_stream(w.ptr);
    ...
    if (src_dtype == dst_dtype) {
        ...
        HIP_ASSERT(hipMemcpyAsync(dst, src, n * element_size, hipMemcpyDeviceToDevice, stream));
        return;
    }
