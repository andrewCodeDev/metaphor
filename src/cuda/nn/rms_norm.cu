/*
 * nn/rms_norm.cu - RMS Normalization forward and backward
 *
...
template<>
__device__ __forceinline__ f32 to_f32(bf16 x) { return __bfloat162float(x); }
...
template<>
__device__ __forceinline__ bf16 from_f32(f32 x) { return __float2bfloat16(x); }
...
extern "C" void cuda_nn_rms_norm_forward(
    Dtype dtype,
...
extern "C" void cuda_nn_rms_norm_backward_x(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* grad_y,
    const void* x,
...
extern "C" void cuda_nn_rms_norm_compute_rms(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* x,
    void* rms_out,
...
extern "C" void cuda_nn_rms_norm_backward_weight(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* grad_y,
    const void* x,
