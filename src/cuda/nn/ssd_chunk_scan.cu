/*
 * nn/ssd_chunk_scan.cu — Structured State Space Duality (SSD) kernels for Mamba-2
 *
...
extern "C" void cuda_nn_ssd_chunk_cumsum_forward(
    Dtype dtype,
...
extern "C" void cuda_nn_ssd_bmm_chunk_forward(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* C_in,
    const void* B_in,
...
extern "C" void cuda_nn_ssd_chunk_state_forward(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* B_in,
    const void* x,
...
extern "C" void cuda_nn_ssd_state_passing_forward(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* states,
...
extern "C" void cuda_nn_ssd_chunk_scan_forward(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* CB,
    const void* x,
...
extern "C" void cuda_nn_ssd_state_passing_backward(
    Dtype dtype,
    StreamHandle stream_handle,
    const void* grad_out,
    const void* dA_chunk_cumsum,
