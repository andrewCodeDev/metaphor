/*
 * loss_kernels.cu - Graph-capture-safe loss function kernels
 *
 * These kernels do NOT use thrust or any runtime allocation,
 * making them compatible with CUDA graph capture.
 */
...
extern "C" void
cuda_loss_softmax_cross_entropy_fwd(int dtype, const void *logits,
  ...
  // Zero the output
  cudaMemsetAsync(loss, 0, (dtype == 0) ? sizeof(float) : sizeof(double),
                  stream);
...
extern "C" void
cuda_loss_softmax_cross_entropy_bwd(int dtype, const void *logits,
...
extern "C" void cuda_loss_mse_fwd(int dtype, const void *pred,
...
extern "C" void cuda_loss_mse_bwd(int dtype, const void *pred,
...
extern "C" void cuda_loss_bce_fwd(int dtype, const void *pred,
                                  const void *target, void *loss, uint64_t n,
                                  int reduction, void *stream_ptr) {
  cudaStream_t stream = static_cast<cudaStream_t>(stream_ptr);
...
extern "C" void cuda_loss_bce_bwd(int dtype, const void *pred,
                                  const void *target, void *grad, uint64_t n,
                                  int reduction, void *stream_ptr) {
  cudaStream_t stream = static_cast<cudaStream_t>(stream_ptr);
...
extern "C" void cuda_loss_weighted_mse_fwd(int dtype, const void *pred,
                                           const void *target,
  ...
  cudaMemsetAsync(loss, 0, elem_size, stream);
  cudaMemsetAsync(weight_sum, 0, elem_size, stream);
...
extern "C" void cuda_loss_weighted_mse_bwd(int dtype, const void *pred,
                                           const void *target,
                                           const void *weight,
...
extern "C" void cuda_loss_weighted_bce_fwd(int dtype, const void *pred,
                                           const void *target,
                                           const void *weight, void *loss,
                                           void *weight_sum, uint64_t n,
                                           void *stream_ptr) {
...
extern "C" void cuda_loss_weighted_bce_bwd(int dtype, const void *pred,
                                           const void *target,
                                           const void *weight,
                                           const void *weight_sum, void *grad,
                                           uint64_t n, void *stream_ptr) {
...
extern "C" void cuda_loss_weighted_softmax_ce_fwd(
...
extern "C" void cuda_loss_weighted_softmax_ce_bwd(
    int dtype, const void *logits, const void *target, const void *weight,
...
extern "C" void cuda_loss_class_weighted_softmax_ce_fwd(
...
extern "C" void cuda_loss_class_weighted_softmax_ce_bwd(
    int dtype, const void *logits, const void *target,
